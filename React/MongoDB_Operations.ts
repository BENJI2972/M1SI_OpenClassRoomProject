 ...
 */
export class MongoDB_Operations {
   ...
   */
  connectionMongoDB (functionToDo : any, jsonQuery : any, miseAJourReact : any) {        
    let that = this;
   ...
   */
  findDocuments(db : any, jsonQuery : any, callback : any, miseAJourReact : any){
   ...
   * @param callback is the callback function, called when this class finished its job
   */
  insertOneDocument(db : any, jsonQuery : any, callback : any, miseAJourReact : any){
    let collection = db.collection('oeuvres');
   ...
   * @param callback is the callback function, called when this class finished its job
   */
  insertManyDocuments(db : any, jsonQuery : any, callback : any, miseAJourReact : any){
    let collection = db.collection('oeuvres');
   ...
   * @param callback is the callback function, called when this class finished its job
   */
  updateOneDocument(db : any, jsonQuery : any, callback : any, miseAJourReact : any){
    let collection = db.collection('oeuvres');
   ...
   * @param callback is the callback function, called when this class finished its job
   */
  updateManyDocuments(db : any, jsonQuery : any, callback : any, miseAJourReact : any){
    let collection = db.collection('oeuvres');
   ...
   * @param callback is the callback function, called when this class finished its job
   */
  deleteOneDocument(db : any, jsonQuery : any, callback : any, miseAJourReact : any){
    let collection = db.collection('oeuvres');
   ...
   * @param callback is the callback function, called when this class finished its job
   */
  deleteManyDocuments(db : any, jsonQuery : any, callback : any, miseAJourReact : any){
    let collection = db.collection('oeuvres');
